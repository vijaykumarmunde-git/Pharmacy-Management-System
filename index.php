...
<body>
    ...
    <section class="topber">
        ...
        <div class="topbar_logo">
            ...
            <h3><i class="fas fa-pills"></i> PHARMEASY</h3>
        </div>
        ...
        <div class="topber__profile">
            <?php
                ...
                <div class="dropdown">
                    ...
                    <?php
                        echo "Welcome $fname(" . ucwords( $role ) . ")";
                        }
                    ?>
                    </button>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>PHARMEASY</span><br>©2020 PHARMEASY All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
